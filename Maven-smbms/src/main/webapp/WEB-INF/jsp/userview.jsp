...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照：</strong><span><img src="/img/${user.idPicPath}" width="300px" height="300px"/></span></p>
            <p><strong>工作证照：</strong><span><img src="/img/${user.workPicPath}" width="300px" height="300px"/></span></p>

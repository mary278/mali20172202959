...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm"  action="${pageContext.request.contextPath }/addsave.html" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label for="a_workPicPath">工作证件照片：</label>
              ...
              <%-- <fm:form method="post" modelAttribute="user" action="${pageContext.request.contextPath }/add.html">

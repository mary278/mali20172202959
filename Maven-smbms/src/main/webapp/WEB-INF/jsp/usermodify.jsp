...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/usermodifysave.html">
			...
			<input type="hidden" name="id" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="birthday" value=" <fmt:formatDate value='${user.birthday}' pattern='yyyy-MM-dd'/>" readonly="readonly" onclick="WdatePicker();">
                    <font color="red"></font>
              </div>

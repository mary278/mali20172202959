...
$(function () {
    ...
    if(errorinfo.val()==null||errorinfo.val()==""){
        a_idPicPath.next().html(
            "*上传文件不能超过500kb * 上传类型必须为：jpg、jpeg、png、pneg");
    }else{
...
$(function () {
    ...
    if(a_workPicPath.val()==null||errorinfo_wp.val()==""){
        a_workPicPath.next().html(
            "*上传文件不能超过500kb * 上传类型必须为：jpg、jpeg、png、pneg");
    }else{

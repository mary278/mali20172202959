...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>企业营业执照：</strong><span><img src="/img/${provider.companyLicPicPath}" width="500px" height="300px"/></span></p>
            <p><strong>组织机构代码证：</strong><span><img src="/img/${provider.orgCodePicPath}" width="500px" height="300px"/></span></p>

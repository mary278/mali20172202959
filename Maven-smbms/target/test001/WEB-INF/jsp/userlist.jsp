...
<%@include file="common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/userlist.html" method="post">
			...
			<div class="providerAdd">
				...
				<div>
					<label>出生日期：</label>
					<input type="text" id="v_birthday" Class="Wdate" value="" readonly="readonly" onclick="WdatePicker();"/>
				</div>

				<div>
					<label>创建日期：</label>
					<input type="text" id="v_creationDate" Class="Wdate" value="" readonly="readonly" onclick="WdatePicker();"/>
				</div>
